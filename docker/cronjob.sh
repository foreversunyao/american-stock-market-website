...
10 * * * * docker exec -it 62f523178289 sh /crawler/stockinfo_collect/collect_daily.sh
10 * * * 2 docker exec -it 62f523178289 python /crawler/elasticsearch_article/article.py
22 * * * 1 sh /home/ubuntu/usstock/docker/gnp_search.sh
10 * * * 2 docker exec -it 62f523178289 python /crawler/elasticsearch_article/article_ana.py
